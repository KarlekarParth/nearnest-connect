    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 hero-gradient items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">Join NearNest today</h2>
          <p className="text-white/80 text-lg">
            Discover verified PGs & hostels near your college. No brokers, no hassle.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="text-muted-foreground mt-2">Start finding your ideal place to stay</p>
          </div>
